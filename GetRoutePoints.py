...
time= str()			# 02:38
AMorPM = str()		# PM or AM
response = urllib2.urlopen('http://www.streetdirectory.com/api/?mode=journey&output=xml&country=sg&q=' + originCoord + '%20to%20'+ destCoord + '&methods=driving&info=1&date='+ date + '&time=' + time + '%20' + AMorPM)
html = response.read()
print html